...
class Rob6323Go2EnvCfg(DirectRLEnvCfg):
    ...
    yaw_rate_reward_scale = 5
    action_rate_reward_scale = -0.5 ## Keeping it zero for now -0.05 

    # Additional reward scales
    orient_reward_scale = -10#-5.0
    lin_vel_z_reward_scale = -0.2#-0.1
    dof_vel_reward_scale = -0.01#-0.0001
    ang_vel_xy_reward_scale = -0.001#-0.001